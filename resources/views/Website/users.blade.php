...
@section('head')
    <style>
        ...
        .bg-image {
            background-image: url('https://static.wixstatic.com/media/3978993e99184d5e8c21f0204cd07bca.png/v1/crop/x_0,y_0,w_150,h_150,q_85,enc_auto/3978993e99184d5e8c21f0204cd07bca.png') !important;
            padding: 5em !important;
        }
...
@endsection
@section('content')
    <main id="main-pages" class="bg-image">
        <div class="">
                    ...
                    <hr>
                     --}}
                                ...
                                <div class="row mb-3 " style="background: #E8E6E6">
                                    <div class="col-lg-6 col-md-12 col-sm-12 px-5 py-3">
                                        <h4>{{ $user->name }}</h4>
                                        <p> {{ \Carbon\Carbon::parse($user->created_at)->format('d/m/Y') }}</p>
                                    </div>
                                    <div
                                        class="col-lg-6 col-md-12 col-sm-12 px-5 py-2 d-flex align-items-center justify-content-end">
                                        <a class="text-dark  btn  py-2 view-post " href="profile/{{ $user->id }}">View
                                            Profile</a>
                                    </div>
                                </div>
                                {{-- @endforeach --}}
                            @endforeach
                        @else
                            <h2 class="text-center py-3 ">No User Available On These Filters</h2>
                        @endif
