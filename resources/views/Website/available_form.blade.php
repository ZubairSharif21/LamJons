...
@section('content')
    <main>
        <section id="main-pages" class="vertical-lines">
            <div class="container">
                <div class="align-form available-form">
                    <div class="row">
                        <div class="col-md-7 order-2">
                            <div class="form-main">
                                <div class="available-form-text">
                                    <h3>Available :</h3>
                                    <p>You are creative. You have talent. And you're available. Create an ad to let people
                                        know what you can do. And what you're interested in doing.</p>
                                </div>
                        ...
                        <div class="col-md-5 order-1">
                            ...
                            <div class="image-form">
                                <img src="./assets/img/girl.png" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
